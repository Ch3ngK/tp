...
public class JsonAdaptedPersonTest {
    ...
    private static final List<String> INVALID_GROUPS = List.of(INVALID_GROUP);
    private static final Map<String, List<JsonAdaptedSession>> NULL_GROUP_SESSIONS = null;
    private static final Map<String, Map<String, Integer>> NULL_ASSIGNMENT_GRADES = null;
    ...
    public void toModelType_invalidAttendanceInSession_throwsIllegalValueException() {
        ...
        JsonAdaptedPerson person = new JsonAdaptedPerson(
                VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_MATRIC_NUMBER, VALID_TAGS, VALID_GROUPS, invalidSessionMap,
                NULL_ASSIGNMENT_GRADES);
    ...
    public void toModelType_invalidGroup_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(
                VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_MATRIC_NUMBER, VALID_TAGS, INVALID_GROUPS,
                NULL_GROUP_SESSIONS, NULL_ASSIGNMENT_GRADES);
    ...
    public void toModelType_invalidGroupNameInGrades_throwsIllegalValueException() {
        ...
        JsonAdaptedPerson person = new JsonAdaptedPerson(
                VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_MATRIC_NUMBER, VALID_TAGS, VALID_GROUPS,
                NULL_GROUP_SESSIONS, invalidGrades);
        assertThrows(IllegalValueException.class, person::toModelType);
    }
    ...
    public void toModelType_negativeGradeValue_throwsIllegalValueException() {
        ...
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_MATRIC_NUMBER,
                VALID_TAGS, VALID_GROUPS, NULL_GROUP_SESSIONS, invalidGrades);
        assertThrows(IllegalValueException.class, person::toModelType);
    }
