...
public class EditCommandParserTest {
    ...
    public void parse_invalidValue_failure() {
        ...
        assertParseFailure(parser, "1" + INVALID_MATRIC_NUMBER_DESC, MatricNumber.MESSAGE_CONSTRAINTS); // invalid address
        ...
        assertParseFailure(parser, "1" + INVALID_NAME_DESC + INVALID_EMAIL_DESC + VALID_MATRIC_NUMBER_AMY + VALID_PHONE_AMY,
